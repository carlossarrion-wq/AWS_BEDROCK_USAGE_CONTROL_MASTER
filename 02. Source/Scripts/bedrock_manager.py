...
# Import modules
from utils.aws_utils import load_config, get_aws_client, check_if_policy_exists
...
class BedrockManager:
    ...
    def setup_team_resources(self, team_name):
        ...
        bedrock_policy_success, bedrock_policy_arn = self.group_manager.create_bedrock_policy(team_name)
        if not bedrock_policy_success:
            ...
            _, bedrock_policy_arn = check_if_policy_exists(bedrock_policy_name, self.policy_manager.iam_client)
        ...
        if not assume_policy_success:
            ...
            # Get the ARN of the existing policy
            _, assume_policy_arn = check_if_policy_exists(assume_policy_name, self.policy_manager.iam_client)
